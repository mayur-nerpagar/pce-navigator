...
export const campusLocations: CampusLocation[] = [
  ...
  { id: 'fy-canteen', name: 'PCE 1st Year Canteen', lat: 21.103592922116718, lng: 79.00497359929443, category: 'amenity', description: 'Canteen for first year students' },
  ...
  { id: 'mechanical-tnp', name: 'Mechanical / T&P / Admin Block', lat: 21.10192817022464, lng: 79.00895179186142, category: 'academic', description: 'Mechanical Engineering, Training & Placement, Admin Block' },
  ...
  { id: 'chemical', name: 'Chemical / BioTechnology', lat: 21.099370478994345, lng: 79.01587686728067, category: 'academic', description: 'Chemical Engineering & BioTechnology Department' },
